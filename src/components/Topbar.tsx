  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-500 to-violet-500 text-xs font-extrabold text-white shadow-md shadow-indigo-500/25">
          Mi
        </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <Button size="sm" className="ml-2 h-8 gap-1.5 bg-gradient-to-r from-indigo-500 to-violet-500 text-xs shadow-md shadow-indigo-500/20" onClick={onExport}>
          查看方案
